# -*- coding: utf-8 -*-
"""
    Provides the Jarvis AdminCommands class.
"""
from telegram.parsemode import ParseMode
from telegram.ext import CommandHandler

from botheart.auth import requires_admin
from botheart.utils import generate_secret, send_email
from botheart import dblog, ACTIVATION_EMAIL, config
...
class AdminCommands(object):  # pylint: disable=too-few-public-methods
    ...
    def __register_handlers(self):
        ...
        self.__dispatcher.add_handler(CommandHandler("rmuser", self.__rm_user, pass_args=True))
    ...
    def __admin_help(update, context):
        ...
        help_dictionary = {
            "adduser": template.format(
                command_order=1,
                command_help="Thêm user vào 1 ",
                command_synctax="/adduser <employee_id> <aha_email> <group>",
                command_ex="/adduser 1716803 phatdt@ahamove.com steven_dang tech"
            ),
            "rmgroup": template.format(
                command_order=2,
                command_help="Xoá user khỏi group",
                command_synctax="/rmgroup <employee_id> <group>",
                command_ex="/rmgroup 1716803 tech"
            )
        }
